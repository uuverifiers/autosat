...
public class NumberOfStatesGuess extends Statement {
  public final Integer integer_1, integer_2;
  public NumberOfStatesGuess(Integer p1, Integer p2) { integer_1 = p1; integer_2 = p2; }

  public <R,A> R accept(grammar.Absyn.Statement.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof grammar.Absyn.NumberOfStatesGuess) {
      grammar.Absyn.NumberOfStatesGuess x = (grammar.Absyn.NumberOfStatesGuess)o;
